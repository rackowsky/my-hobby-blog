...
export const HeroContentWrapper = styled.div`
    ...
    > h1 {
        font-weight: 700;
        color: #fff;
        font-size: ${ViewportCalculator(70, "desktop")};

        @media ${theme.media.desktop} {
            font-size: 65px;
        }
        @media ${theme.media.laptop} {
            font-size: ${ViewportCalculator(70, "laptop")};
        }
        @media ${theme.media.tablet} {
            font-size: ${ViewportCalculator(65, "tablet")};
        }
        @media ${theme.media.largeMobile} {
            font-size: ${ViewportCalculator(55, "largeMobile")};
        }
        @media ${theme.media.mobile} {
